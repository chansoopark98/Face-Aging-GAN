...
# TODO(wiki_dataset): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
...
# TODO(wiki_dataset): BibTeX citation
_CITATION = """
"""


class WikiDataset(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for wiki_dataset dataset."""
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    return {
        'train': self._generate_examples(rgb_path=extracted_path/'wiki_crop', csv_path=extracted_path)
    }


  def _generate_examples(self, rgb_path, csv_path):
    csv_file_dir = str(csv_path)+'/wiki.csv'
