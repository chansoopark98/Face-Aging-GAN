...
def ce_loss(y_true, y_pred):
    return losses.CategoricalCrossentropy(from_logits=False)(y_true=y_true, y_pred=y_pred)

def sparse_ce_loss(y_true, y_pred):
    return losses.SparseCategoricalCrossentropy(from_logits=True)(y_true=y_true, y_pred=y_pred)
